...
export function MaterialSymbolsEditSquareOutline({color = defaultColor, size = defaultSize}: Props) {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" color={color} width={size} height={size} viewBox={`0 0 ${size} ${size}`}>
      <path
        fill="currentColor"
...
export function MaterialSymbolsCheckCircleOutline({color = defaultColor, size = defaultSize}: Props) {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" color={color} width={size} height={size} viewBox={`0 0 ${size} ${size}`}>
      <path
        fill="currentColor"
...
export function MaterialSymbolsDownloadForOfflineOutline({color = defaultColor, size = defaultSize}: Props) {
  return (
...
export function MaterialSymbolsCodeBlocksOutline({color = defaultColor, size = defaultSize}: Props) {
  return (
